...
class Map(object):
    ...
    def collision_check(self, x, y):
        ...
        #         A = get_distance(a[0], a[1], b[0], b[1])
        #         B = get_distance(target[0], target[1], a[0], a[1])
        #         C = get_distance(target[0], target[1], b[0], b[1])
        #
